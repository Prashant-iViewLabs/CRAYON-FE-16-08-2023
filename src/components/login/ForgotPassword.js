...
import { Avatar, Box, Button, Dialog, DialogActions, DialogContent, DialogTitle, IconButton, InputBase, Paper, TextField, Typography } from '@mui/material'
        ...
        ><DialogTitle onClose={closeFunc}>
            ...
            <DialogActions
                ...
                <Button
                    ...
                    variant="contained"
                    color="grayButton100" onClick={closeFunc}
                >
                    Cancel
                </Button>
                <Button
