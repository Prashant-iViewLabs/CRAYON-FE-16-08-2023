...
import link from "../../../assets/CircularIcon/Red/Circular Icons__Red_Own_Equipment.svg";
...
import { getToolsData } from "../../../redux/admin/searchSlice";
import SmallButtonTalent from "../../common/SmallButtonTalent";
import ToolsAccordian from "./dialogBox/ToolsAccordian";
...
export default function ToolsSearch() {
  ...
  const handleSearch = async (title, titlelastkey) => {
    ...
    if (title !== "") {
      const { payload } = await dispatch(getToolsData(newBasicData));
          ...
          >
            ...
            >
              <InputBase
                ...
                placeholder={"Enter the tools you would like to search for..."}
