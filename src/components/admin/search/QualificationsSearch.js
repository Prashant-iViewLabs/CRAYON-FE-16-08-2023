...
export default function QualificationsSearch() {
  ...
  const handleSearch = async (title, titlelastkey) => {
    ...
    if (title !== "") {
      const { payload } = await dispatch(getQualificationsData(newBasicData));
          ...
          >
            ...
            >
              <InputBase
                ...
                placeholder={
                  "Enter the qualification you would like to search for..."
                }
