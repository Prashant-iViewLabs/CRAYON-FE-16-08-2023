...
import link from "../../../assets/CircularIcon/Red/Circular Icons__Red_Filter_Stats.svg";
...
import { getSkillsData } from "../../../redux/admin/searchSlice";
import SmallButtonTalent from "../../common/SmallButtonTalent";
import SkillsAccordian from "./dialogBox/SkillsAccordian";
...
export default function TagsSearch() {
  ...
  const handleSearch = async (title, titlelastkey) => {
    ...
    if (title !== "") {
      const { payload } = await dispatch(getSkillsData(newBasicData));
          ...
          >
            ...
            >
              <InputBase
                ...
                placeholder={"Enter the skills you would like to search for..."}
