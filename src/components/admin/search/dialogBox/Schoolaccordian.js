...
import { getQualCandidateData, getSchoolCandidateData } from "../../../../redux/admin/searchSlice";
...
export default function Schoolaccordian({
  titlesList,
  traits,
  handleTitleScroll,
  basicData,
  ...
  const getCandidateData = async (data, lastkey) => {
    ...
    const { payload } = await dispatch(getSchoolCandidateData(candidateData));
