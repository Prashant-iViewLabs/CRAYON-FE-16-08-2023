...
import { getLanguageCandidateData } from "../../../../redux/admin/searchSlice";
...
export default function LanguageAccordian({
  titlesList,
  traits,
  handleTitleScroll,
  basicData,
  ...
  const getCandidateData = async (data, lastkey) => {
    ...
    const { payload } = await dispatch(getLanguageCandidateData(candidateData));
