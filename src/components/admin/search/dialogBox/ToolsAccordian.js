...
import { getTitlesCandidateData, getToolsCandidateData } from "../../../../redux/admin/searchSlice";
...
export default function ToolsAccordian({
  titlesList,
  traits,
  handleTitleScroll,
  basicData,
  ...
  const getCandidateData = async (data, lastkey) => {
    ...
    const { payload } = await dispatch(getToolsCandidateData(candidateData));
