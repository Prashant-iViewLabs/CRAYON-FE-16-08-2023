...
export default function Accordian({ titlesList, traits, handleTitleScroll, basicData, titlesListKey }) {
                  ...
                  >
...

                    {
                      candidateList.length <= 0 ? (
                        <Typography sx={{ fontSize: "14px", fontWeight: 900, textAlign: "center" }}>
                          No candidate
                        </Typography>
                      ) : (
