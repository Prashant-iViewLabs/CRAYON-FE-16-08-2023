...
import { getQualCandidateData, getTownsCandidateData } from "../../../../redux/admin/searchSlice";
...
export default function TownAccordian({
  titlesList,
  traits,
  handleTitleScroll,
  basicData,
  ...
  const getCandidateData = async (data, lastkey) => {
    ...
    const { payload } = await dispatch(getTownsCandidateData(candidateData));
