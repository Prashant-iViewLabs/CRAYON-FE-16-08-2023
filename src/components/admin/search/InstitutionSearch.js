...
import link from "../../../assets/CircularIcon/Red/Circular Icons__Red_Instructions.svg";
...
import { getInstitutionData } from "../../../redux/admin/searchSlice";
import SmallButtonTalent from "../../common/SmallButtonTalent";
import InstitutionAccordian from "./dialogBox/InstitutionAccordian";
...
export default function InstitutionSearch() {
  ...
  const handleSearch = async (title, titlelastkey) => {
    ...
    if (title !== "") {
      const { payload } = await dispatch(getInstitutionData(newBasicData));
          ...
          >
            ...
            >
              <InputBase
                ...
                placeholder={
                  "Enter the institution you would like to search for..."
                }
