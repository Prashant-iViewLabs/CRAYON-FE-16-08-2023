...
import link from "../../../assets/CircularIcon/Red/Circular Icons__Red_Location.svg";
...
import { getTownsData } from "../../../redux/admin/searchSlice";
import SmallButtonTalent from "../../common/SmallButtonTalent";
import TownAccordian from "./dialogBox/TownAccordian";
...
export default function TownsSearch() {
  ...
  const handleSearch = async (title, titlelastkey) => {
    ...
    if (title !== "") {
      const { payload } = await dispatch(getTownsData(newBasicData));
          ...
          >
            ...
            >
              <InputBase
                ...
                placeholder={"Enter the town you would like to search for..."}
