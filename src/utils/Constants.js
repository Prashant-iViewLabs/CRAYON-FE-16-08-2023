...
export const ADMIN_LFET_PANEL = [
  ...
  },
  {
    ...
    menuItems: [
      { id: 0, label: "Pending Jobs", path: "pending-jobs" },
      { id: 1, label: "Active jobs", path: "active-jobs" },
      { id: 2, label: "Paused jobs", path: "paused-jobs" },
      { id: 3, label: "Closed jobs", path: "closed-jobs" },
      // { label: 'Post a job' },
    ],
  },
  {
  ...
  },
  {
    ...
    menuItems: [
      ...
      { id: 6, label: "Institutions" },
      { id: 7, label: "Associations" },
      { id: 8, label: "Schools" },
      { id: 9, label: "Towns" },
      { id: 10, label: "Nationalities" },
      { id: 11, label: "Languages" },
    ],
  },
  {
    id: 4,
